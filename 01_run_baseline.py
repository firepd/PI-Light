...
parser.add_argument('--model', type=str, default='MaxPressure', help='[CoLight, EcoLight, FixedTime, FRAP, MaxPressure, MPLight, SOTL]')
...
def run_an_experiment(inter_name, flow_idx, seed):
    ...
    if isinstance(env.n_agent[0], BaseDRL):
        ...
        for config['current_episode_idx'] in range(1, 128 + 1):
